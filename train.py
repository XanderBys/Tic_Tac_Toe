    ...
    for i in range(rounds):
        while True:
            ...
            for player in players:
                ...
                # choose action
                action = player.choose_action(env.state, moves=env.get_legal_moves())
...
if __name__ == '__main__':
    ...
    p1 = Player('p1', environment, 1, NUM_ROUNDS//4, Model(9, 9, 100, dueling=p1_dueling)
                , Model(9, 9, 100, dueling=p1_dueling), BATCH_SIZE, (0.9, 0.15, LAMBDA),
                use_PER=p1_PER, PER_hyperparams=(0.01, 0.6, 0.4))
    p2 = Player('p2', environment,-1, NUM_ROUNDS//4, Model(9, 9, 100, dueling=p2_dueling)
                , Model(9, 9, 100, dueling=p2_dueling), BATCH_SIZE, (0.9, 0.15, LAMBDA),
                use_PER=p1_PER, PER_hyperparams=(0.01, 0.6, 0.4))
